...
Vec make_vec(const std::tuple<float_type, float_type, float_type>&& floats) {
    ...
    return Vec(float_traits_type(std::get<0>(floats)),
               float_traits_type(std::get<1>(floats)),
               float_traits_type(std::get<2>(floats)));
}
...
Vec make_vec(const std::tuple<float_type, float_type, float_type, float_type>&& floats) {
    ...
    return Vec(float_traits_type(std::get<0>(floats)),
               float_traits_type(std::get<1>(floats)),
               float_traits_type(std::get<2>(floats)),
               float_traits_type(std::get<3>(floats)));
}
 ...
 * @return 转换后的目标对象
 */
template <class Vec1, class Vec2> inline Vec1 convertTo(const Vec2& vector) {
