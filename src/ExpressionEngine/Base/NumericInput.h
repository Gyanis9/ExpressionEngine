...
namespace ExpressionEngine::Base
{
     ...
     * @return 生效的分隔符与分组开关
     */
    [[nodiscard]] NumericGrammarPolicy numericGrammarPolicy(const NumericLocaleContext &locale, NumericSyntaxContext syntax);
     ...
     */
    [[nodiscard]] bool localizedDigitAt(std::string_view input, std::size_t position, const NumericLocaleContext &locale, int &digit, std::size_t &consumedBytes);
     ...
     */
    [[nodiscard]] LocalizedNumberResult scanLocalizedNumber(std::string_view input, const NumericLocaleContext &locale, NumericSyntaxContext syntax);
} // namespace ExpressionEngine::Base
