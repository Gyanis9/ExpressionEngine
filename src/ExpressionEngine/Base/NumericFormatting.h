 ...
 */
[[nodiscard]] std::expected<NumericLocaleContext, NumericLocaleError>
createNumericLocaleContext(std::string_view localeId);
 ...
 */
[[nodiscard]] std::string formatNumericValue(double value,
                                             int precision,
                                             NumberNotation notation,
                                             bool omitGroupSeparator,
