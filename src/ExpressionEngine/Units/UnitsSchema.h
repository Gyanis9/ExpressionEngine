...
public:
    ...
    translate(const Quantity& quant, double& factor, std::string& unitString) const;
     ...
     */
    [[nodiscard]] std::string translate(const Quantity& quant,
...
private:
     ...
     */
    [[nodiscard]] static std::string toLocale(const Quantity& quant,
                                              const Base::NumericLocaleContext& formatting,
                                              double factor,
